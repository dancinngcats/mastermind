...
module MessageModule
  ...
  def lets_play
    slow_it_down("I have generated a beginner sequence with four elements made up of: #{"red".red}, #{"green".green}, #{"blue".blue}, and #{"yellow".yellow}.\n\nUse (q)uit at any time to end the game. What's your guess?\n", 0.015)
    break_it_up
  end
  ...
  def right_letters
    slow_it_down("You are not using correct characters... Use first letters from corresponding colors: #{"(r)ed".red}, #{"(y)ellow".yellow}, #{"(b)lue".blue}, or #{"(g)reen".green}. Let's try again!\n", 0.015)
    break_it_up
  end
